...
if __name__ == "__main__":
    ssh_87 = SSH()
    ssh_87.connect("55.148.1.87", "root", "Admin@123stor")
    ssh_88 = SSH()
    ssh_88.connect("55.148.1.88", "root", "Admin@123stor")
    ssh_89 = SSH()
    ssh_89.connect("55.148.1.89", "root", "Admin@123stor")

    result = ssh_87.run_command("dmg sys query -v")
    print(result)
    time.sleep(5)
    result = ssh_87.run_command("dmg pool query p1")
    print(result)
    time.sleep(10)
    result = ssh_87.run_command("ifdown ens1f0")
    print("87.ens1f0 down")
    time.sleep(2177)
    result = ssh_87.run_command("ifup ens1f0")
    print("87.ens1f0 up")
    time.sleep(96)
    result =ssh_88.run_command("ifdown ens1f0")
    print("88.ens1f0 down")
    time.sleep(15)
    result =ssh_89.run_command("ifdown ens1f0")
    print("89.ens1f0 down")
    time.sleep(408)
    result =ssh_88.run_command("ifup ens1f0")
    print("88.ens1f0 up")
    time.sleep(15)
    result =ssh_89.run_command("ifup ens1f0")
    print("88.ens1f0 up")

    ssh_87.close_connection()
    ssh_88.close_connection()
    ssh_89.close_connection()
